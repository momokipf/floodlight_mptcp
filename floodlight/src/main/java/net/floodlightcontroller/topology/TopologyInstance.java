...
public class TopologyInstance {
    ...
    * Computes end-to-end path including src/dst switch
    * ports in addition to the switches. This chains into
    * {@link #getPathsFast(DatapathId, DatapathId)} previous.
    **/
    public List<Path> getPathsFast(DatapathId srcId, OFPort srcPort,
            DatapathId dstId, OFPort dstPort,int k ){
        List<Path> r = getPathsFast(srcId,dstId,k);
